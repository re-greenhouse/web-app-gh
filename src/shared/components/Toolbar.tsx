...
export const Toolbar = (): ReactElement => {
  ...
  const getDesigns = (item: string) => {
    if (item === activePage)
      return "flex gap-3 items-center font-sans p-3 hover:scale-95 duration-300 border-b-2 border-primary text-primary";
  ...
  return (
    <div>
      <header className="flex justify-between items-center p-6 lg:p-5">
        <Link
          to="/"
          className="flex justify-center items-center text-primary hover:scale-95 duration-300 gap-1"
        >
          <svg
        ...
        <div
          id="sections"
          className="flex lg:flex-row flex-row-reverse justify-center items-center lg:gap-24 gap-5"
        >
          <div className="items-center gap-24 hidden lg:flex">
            <div className="flex gap-24 text-secondary">
              ...
              <Link to="/company" className={getDesigns("company")}>
                ...
                >
                  <path
                    d="M16.4997 15H14.6663V17H16.4997M16.4997 11H14.6663V13H16.4997M18.333 19H10.9997V17H12.833V15H10.9997V13H12.833V11H10.9997V9H18.333M9.16634 7H7.33301V5H9.16634M9.16634 11H7.33301V9H9.16634M9.16634 15H7.33301V13H9.16634M9.16634 19H7.33301V17H9.16634M5.49967 7H3.66634V5H5.49967M5.49967 11H3.66634V9H5.49967M5.49967 15H3.66634V13H5.49967M5.49967 19H3.66634V17H5.49967M10.9997 7V3H1.83301V21H20.1663V7H10.9997Z"
                    fill="#898989"
                  />
                </svg>
                Mi empresa
          ...
          <div
            className={`absolute z-20 translate-y-24  ${
              dropDownToolbar ? "hidden" : ""
            } bg-white border rounded-lg lg:hidden`}
            ref={menuRef}
          >
