...
export const Toolbar = (): ReactElement => {
  ...
  const getDesigns = (item: string) => {
    if (item === activePage) return "flex md:gap-1 gap-3 items-center font-sans p-3 hover:scale-95 duration-300 border-b-2 border-primary text-primary";
    return "flex md:gap-1 gap-3 items-center font-sans p-3 border-b-2 border-background hover:scale-95 duration-300"
  }
    ...
    <header className="flex justify-between items-center p-6 lg:p-5">
      ...
      <div id="sections" className="flex md:flex-row flex-row-reverse justify-center items-center md:gap-24 gap-5">
        <div className="items-center gap-24 hidden md:flex sm:hidden">
          <div className="flex md:gap-10 gap-24 text-secondary">
            <Link to="/" className={getDesigns('cropsInProgress')}>
              ...
              <h1 className="md:text-xs">Cultivos en progreso</h1>
            </Link>
            ...
            <h1 className="md:text-xs">Cultivos finalizados</h1>
            </Link>
            ...
            <h1 className="md:text-xs">Mi empresa</h1>
            </Link>
          </div>
        </div>
